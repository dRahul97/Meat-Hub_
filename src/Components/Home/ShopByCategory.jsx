...
import orangeSection from "../Images/light-orange-section.jpg";
import { Link } from "react-router-dom";
import shopCategory from "../Home/ShopByCategory.module.css";

const ShopByCategoryImages = [
  {
    id: 1,
    image:
...
const ShopByCategory = () => {
  return (
    <>
      ...
      >
        <h2 className={shopCategory.h2}>Shop by categories</h2>
        <p style={{ color: "#959799", paddingBottom: "20px" }}>
